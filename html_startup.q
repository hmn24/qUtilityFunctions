...
.qutils.loadDir: {op: (@[system;;::] "l ", _[1]  @) each string .Q.dd'[a; key a: hsym x]; -1 $[not all null op;"Error loading q scripts";"Loading q scripts successfully"];};

/ Load all the key scripts for the html interfaces to work
.qutils.loadDir[`qscripts];
